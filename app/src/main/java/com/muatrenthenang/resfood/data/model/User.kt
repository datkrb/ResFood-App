...
data class User(
    ...
    @get:com.google.firebase.firestore.PropertyName("isLocked")
    @set:com.google.firebase.firestore.PropertyName("isLocked")
    var isLocked: Boolean = false // Trạng thái khóa tài khoản
) {
    /**
